...
from core.pagination import AsyncBasePagination, BaseMiniAnimeInfo
from exceptions.utils import not_find

class AsyncAniBoomPagination(AsyncBasePagination):
    MAX_ANIME_IN_PAGE = 16
    
    def __init__(self, url, session: httpx.AsyncClient, engine = 'html.parser', *args, **kwargs):
    ...
    @classmethod
    async def _find(cls, url: str, session: httpx.AsyncClient, engine: str,  *args, **kwargs):
